...
const nextConfig = {
  ...
  async headers() {
    return [
      ...
      // Fonts, icons, images — cache for 30 days
      {
      ...
      // Marketing pages — cache 1 hour at CDN edge, serve stale for up to 1 day while revalidating
      {
        source: "/",
        headers: [
          {
      ...
      // Dynamic pages — no CDN cache (user-specific)
      {
        source: "/dashboard",
        headers: [
          {
