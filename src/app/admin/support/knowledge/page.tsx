  ...
  return (
    <div>
      ...
      <div className="border-b border-stone-200 bg-white backdrop-blur-2xl">
        <div className="max-w-[1400px] mx-auto px-4 py-3 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <Link href="/admin/support" className="p-2 rounded-lg hover:bg-stone-100 transition-colors">
              <ArrowLeft className="w-5 h-5 text-stone-600" />
            </Link>
            <BookOpen className="w-6 h-6 text-stone-500" />
            <h1 className="text-lg font-semibold text-stone-800">Knowledge Base</h1>
          ...
          <div className="flex items-center gap-2">
            ...
            <button onClick={fetchArticles} className="p-2 rounded-lg hover:bg-stone-100 transition-colors">
      ...
      <div className="max-w-[1400px] mx-auto flex" style={{ height: "calc(100vh - 60px)" }}>
        {/* Sidebar — Categories */}
        <div className="w-56 border-r border-stone-200 p-3 flex flex-col gap-1">
          <button
            onClick={() => {
          ...
          <div className="mt-6 pt-4 border-t border-stone-200">
            <p className="px-3 text-xs text-stone-700 mb-2">How it works</p>
            <p className="px-3 text-xs text-stone-600 leading-relaxed">
          ...
          <div className="flex-1 overflow-y-auto">
            {creating || editing ? (
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full bg-stone-50 border border-stone-200 rounded-lg px-4 py-2 text-sm text-stone-800 placeholder-stone-400 focus:outline-none focus:border-stone-400"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="w-full bg-stone-50 border border-stone-200 rounded-lg px-4 py-2 text-sm text-stone-800 focus:outline-none focus:border-stone-400"
                    >
                      {CATEGORIES.map((cat) => (
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      rows={15}
                      className="w-full bg-stone-50 border border-stone-200 rounded-lg px-4 py-3 text-sm text-stone-800 placeholder-stone-400 focus:outline-none focus:border-stone-400 resize-none font-mono"
                    />
                  </div>
                  ...
                  <div>
                    <label className="block text-sm text-stone-600 mb-1">
                      Keywords{" "}
                      <span className="text-stone-600">— comma-separated, helps matching</span>
                    </label>
                    <input
                      type="text"
              ...
              <div className="text-center py-20 text-stone-600">
                ...
                <p className="text-lg mb-2 text-stone-600">No articles yet</p>
                    ...
                    <div className="flex items-start justify-between">
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2 mb-1">
                          ...
                          <span className="text-xs px-2 py-0.5 rounded bg-stone-100 text-stone-600 capitalize flex-shrink-0">
                        ...
                        {article.keywords && (article.keywords as string[]).length > 0 && (
                          <div className="flex items-center gap-1 mt-2">
                            ...
                            {(article.keywords as string[]).slice(0, 5).map((kw) => (
                              <span
                                key={kw}
                                className="text-xs text-stone-700 bg-stone-100 px-1.5 py-0.5 rounded"
                              >
                                {kw}
                              </span>
                            ))}
                      ...
                      <div className="flex items-center gap-1 ml-4 flex-shrink-0">
                        ...
                        <button
                          ...
                          className="p-1.5 rounded text-stone-600 hover:text-stone-700 hover:bg-stone-100 transition-colors"
                        >
                          <Edit3 className="w-4 h-4" />
                        </button>
                        <button
                          onClick={() => deleteArticle(article.id)}
                          className="p-1.5 rounded text-stone-600 hover:text-red-500 hover:bg-red-50 transition-colors"
                        >
