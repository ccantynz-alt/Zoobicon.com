...
const TLD_DATA: Record<string, TldInfo> = {
  ...
  sh: {
    ...
    examples: ["deno.sh", "bun.sh", "warp.sh", "railway.sh", "render.sh"],
  },
  dev: {
    tld: "dev",
    price: 14.99,
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {[
              ...
              { icon: Server, title: "Free Hosting", desc: "Deploy through our partner cloud — fast, reliable, included in the price" },
            ].map((f) => (
