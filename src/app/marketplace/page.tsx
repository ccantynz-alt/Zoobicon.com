...
const FALLBACK_ITEMS: MarketplaceItem[] = [
  ...
  { id: "uptime-monitor", name: "Uptime Monitor", category: "Analytics", description: "24/7 website monitoring with instant alerts via email, Hash, and SMS. 1-minute check intervals.", price: 0, priceLabel: "Free", priceType: "free", rating: 4.4, installs: "5.6K", iconName: "Clock", gradient: "from-teal-500 to-cyan-600" },
