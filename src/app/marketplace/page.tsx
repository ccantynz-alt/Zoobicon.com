...
const FALLBACK_ITEMS: MarketplaceItem[] = [
  ...
  { id: "custom-code-injection", name: "Custom Code Injection", category: "Developer Tools", description: "Add custom HTML, CSS, and JavaScript to any page. Header/footer injection, Google Tag Manager, pixels.", price: 0, priceLabel: "Free", priceType: "free", rating: 4.4, installs: "9.2K", iconName: "Code2", gradient: "from-stone-500 to-stone-600" },
