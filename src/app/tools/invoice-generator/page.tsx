      ...
      <div className="max-w-6xl mx-auto px-6 py-12">
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          <div className="space-y-6 no-print">
            ...
            <div className="bg-white/[0.03] border border-white/[0.06] rounded-2xl p-6">
              ...
              <div className="space-y-3">
                <input
                  ...
                  className="w-full bg-white/[0.05] border border-white/[0.08] rounded-xl px-4 py-3 text-sm placeholder:text-white/20 focus:outline-none focus:ring-2 focus:ring-amber-500/40"
                />
                <textarea
                  value={bizAddress}
                  ...
                  placeholder="Address"
                  rows={2}
                  className="w-full bg-white/[0.05] border border-white/[0.08] rounded-xl px-4 py-3 text-sm placeholder:text-white/20 focus:outline-none focus:ring-2 focus:ring-amber-500/40 resize-none"
                />
                <input
                  type="email"
                  value={bizEmail}
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-white/[0.05] border border-white/[0.08] rounded-xl px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-amber-500/40"
                  />
                </div>
                <div>
                  ...
                  <select
                    ...
                    className="w-full bg-white/[0.05] border border-white/[0.08] rounded-xl px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-amber-500/40 appearance-none"
                  >
                    {CURRENCIES.map(c => (
                ...
                {items.map(item => (
                  <div key={item.id} className="grid grid-cols-[1fr_70px_90px_90px_32px] gap-2 items-center">
                    <input
                      ...
                      className="bg-white/[0.05] border border-white/[0.08] rounded-lg px-3 py-2 text-sm placeholder:text-white/20 focus:outline-none focus:ring-2 focus:ring-amber-500/40"
                    />
                    <input
                      type="number"
                      value={item.quantity || ""}
                      ...
                      min="0"
                      className="bg-white/[0.05] border border-white/[0.08] rounded-lg px-3 py-2 text-sm text-center focus:outline-none focus:ring-2 focus:ring-amber-500/40"
                    />
                    <input
                      type="number"
                      value={item.rate || ""}
                      ...
                      min="0"
                      step="0.01"
                      className="bg-white/[0.05] border border-white/[0.08] rounded-lg px-3 py-2 text-sm text-right focus:outline-none focus:ring-2 focus:ring-amber-500/40"
                    />
                    ...
                    <button
                      ...
                      className="p-1.5 text-white/20 hover:text-red-400 transition-colors disabled:opacity-20"
              ...
              <div className="mt-4 pt-4 border-t border-white/[0.06]">
                <div>
                  ...
                  <input
                    ...
                    max="100"
                    step="0.5"
                    className="w-32 bg-white/[0.05] border border-white/[0.08] rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-amber-500/40"
                  />
            ...
            <button
              onClick={handlePrint}
              className="w-full py-4 rounded-2xl bg-amber-600 hover:bg-amber-500 text-white font-semibold text-lg transition-colors flex items-center justify-center gap-2"
            >
        ...
        {/* CTA */}
        <div className="mt-20 text-center bg-gradient-to-br from-amber-600/10 to-orange-600/10 border border-amber-500/10 rounded-2xl p-10 no-print">
          ...
          <Link
            ...
            className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-amber-600 hover:bg-amber-500 font-semibold transition-colors"
          >
