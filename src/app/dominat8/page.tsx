...
export default function Dominat8Page() {
  ...
  return (
    <div className="min-h-screen bg-[var(--paper)] text-white relative">
      ...
      {/* Nav */}
      <nav className="relative sticky top-0 z-50 border-b border-white/[0.10] bg-[var(--paper)]/90 backdrop-blur-xl">
      ...
      {/* Footer */}
      <footer className="border-t border-white/[0.06] bg-[var(--paper)]">
