  ...
  return (
    <div className="min-h-screen bg-[var(--paper)] text-white overflow-hidden relative">
      ...
      <section className="relative py-24 px-4">
        <div className="absolute inset-0 bg-[linear-gradient(rgba(232,64,43,0.02)_1px,transparent_1px),linear-gradient(90deg,rgba(232,64,43,0.02)_1px,transparent_1px)] bg-[size:40px_40px]" />
            ...
            {PRICING.map((tier) => (
              <motion.div
                ...
                className={`relative p-8 rounded-xl border transition-all ${
                  tier.highlight
                    ? "border-zoo-500/40 bg-zoo-500/[0.03] shadow-[0_0_60px_-15px_rgba(232,64,43,0.15)]"
