...
export default function ShowcasePage() {
  ...
  return (
    <div className="min-h-screen bg-[var(--paper)] text-white">
      {/* Nav */}
      <nav className="fixed top-0 left-0 right-0 z-50 bg-[var(--paper)]/80 backdrop-blur-xl border-b border-white/[0.06]">
      ...
      <div className="pt-32 pb-8 px-6 text-center">
        ...
        >
          ...
          <h1 className="text-5xl sm:text-6xl font-black tracking-tight mb-4">
            The <span className="bg-gradient-to-r from-stone-400 to-stone-400 bg-clip-text text-transparent">Showcase</span>
          </h1>
          <p className="text-lg text-gray-400 max-w-2xl mx-auto">
            Hand-picked examples of the kind of site Zoobicon produces — same component registry,
            same design language. Real customer builds will appear here as we ship. Until then, try
            a generation yourself in the{" "}
            <Link href="/builder" className="underline decoration-stone-500/40 hover:decoration-stone-400">
              builder
            </Link>
            .
          </p>
