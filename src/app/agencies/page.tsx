...
const PRIMARY_CTA = {
  background: "linear-gradient(135deg, #e8402b 0%, #F0DCB8 100%)",
  color: "#0a1628",
  boxShadow: "0 14px 40px -16px rgba(232,64,43,0.5)",
} as const;
...
const SERIF: React.CSSProperties = {
  ...
  fontStyle: "italic",
  fontWeight: 400,
  background: "linear-gradient(180deg, #ef5440 0%, #e8402b 55%, #c2331f 100%)",
      ...
      <section className="relative pt-20 pb-24 md:pt-28 md:pb-32 overflow-hidden">
        <div className="pointer-events-none absolute inset-0 overflow-hidden" aria-hidden>
          <div className="absolute left-1/2 top-0 h-[720px] w-[1200px] -translate-x-1/2 rounded-full blur-[160px]"
            style={{ background: "radial-gradient(closest-side, rgba(232,64,43,0.09), transparent 70%)" }} />
        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 text-center">
          <div className="inline-flex items-center gap-2 rounded-full border border-[#e8402b]/20 bg-[#e8402b]/[0.04] px-3 py-1 text-[11px] font-medium text-[#e8402b]/90 mb-8">
          ...
          <div className="flex flex-wrap justify-center gap-2 mb-10 max-w-3xl mx-auto">
            {["White-label", "Unlimited clients", "Bulk generation", "SEO agents", "Team roles", "Priority support"].map((pill) => (
              ...
              >
                <Check className="w-3 h-3" style={{ color: "#e8402b" }} />
                {pill}
              </span>
            ))}
          </div>
          ...
          <div className="flex flex-wrap items-center justify-center gap-3 mb-16">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 rounded-full border border-white/[0.12] bg-white/[0.03] px-7 py-3.5 text-[14px] font-medium text-white/80 backdrop-blur transition-all duration-500 hover:-translate-y-0.5 hover:border-[#e8402b]/35 hover:text-[#e8402b]"
            >
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-5 max-w-4xl mx-auto">
            {HERO_STATS.map((stat) => (
              ...
              >
                <div className="text-3xl md:text-4xl font-semibold tracking-[-0.02em] mb-1" style={{ color: "#e8402b" }}>
                  {stat.value}
                </div>
      ...
      <section id="white-label" className="relative py-20 md:py-24 border-t border-white/[0.06]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-14">
            <div className="inline-flex items-center gap-2 rounded-full border border-[#e8402b]/20 bg-[#e8402b]/[0.04] px-3 py-1 text-[11px] font-medium text-[#e8402b]/90 mb-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
            {WHITE_LABEL_FEATURES.map((f) => (
              <div
                key={f.title}
                className="group relative overflow-hidden rounded-[24px] border border-white/[0.08] p-7 transition-all duration-500 hover:-translate-y-1 hover:border-[#e8402b]/25"
                style={{ background: CARD_BG }}
              >
                <div className="pointer-events-none absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-500"
                  style={{ background: "radial-gradient(closest-side, rgba(232,64,43,0.07), transparent 70%)" }} />
                <div className="relative">
                  <div className="mb-5 inline-flex h-11 w-11 items-center justify-center rounded-xl border border-[#e8402b]/20 bg-[#e8402b]/[0.05]">
                    <f.icon className="h-5 w-5 text-[#e8402b]" />
                  </div>
              ...
              >
                ...
                <div className="relative">
                  <div className="flex items-start justify-between mb-5">
                    <div className="inline-flex h-12 w-12 items-center justify-center rounded-xl border border-[#e8402b]/20 bg-[#e8402b]/[0.05]">
                      <tool.icon className="h-5 w-5 text-[#e8402b]" />
                    </div>
                    <span
                      className="rounded-full border border-[#e8402b]/20 bg-[#e8402b]/[0.05] px-2.5 py-1 text-[10px] font-semibold uppercase tracking-wide"
                      style={{ color: "#e8402b" }}
                    >
                      {tool.stat}
                    </span>
      ...
      <section className="relative py-20 md:py-24 border-t border-white/[0.06] overflow-hidden">
        <div className="pointer-events-none absolute inset-0" aria-hidden>
          <div className="absolute left-1/2 top-1/2 h-[480px] w-[860px] -translate-x-1/2 -translate-y-1/2 rounded-full blur-[140px]"
            style={{ background: "radial-gradient(closest-side, rgba(232,64,43,0.06), transparent 70%)" }} />
        </div>
        <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid md:grid-cols-3 gap-5">
            {TESTIMONIALS.map((t) => (
              <div
                key={t.name}
                className="rounded-[24px] border border-white/[0.08] p-7 transition-all duration-500 hover:-translate-y-1 hover:border-[#e8402b]/25"
                style={{ background: CARD_BG }}
              >
                <div className="flex gap-0.5 mb-5">
                  {Array.from({ length: t.stars }).map((_, j) => (
                    <Star key={j} className="w-4 h-4" style={{ color: "#e8402b", fill: "#e8402b" }} />
                  ))}
                </div>
            ...
            {TIERS.map((tier) => (
              <div
                ...
                className={`relative rounded-[24px] p-7 transition-all duration-500 hover:-translate-y-1 ${
                  tier.featured ? "border-2 border-[#e8402b]/35" : "border border-white/[0.08] hover:border-[#e8402b]/25"
                }`}
                style={{
              ...
              >
                {tier.featured && (
                  <div
                    ...
                    style={{ background: "linear-gradient(135deg, #e8402b 0%, #F0DCB8 100%)", color: "#0a1628" }}
                  >
                    Most popular
                  </div>
                )}
                ...
                <div className="flex items-baseline gap-1 mb-3">
                  <span className="text-4xl font-semibold tracking-[-0.02em]" style={{ color: "#e8402b" }}>{tier.price}</span>
                ...
                <ul className="space-y-2.5 mb-7">
                  {tier.features.map((f) => (
                    <li key={f} className="flex items-start gap-2 text-[13px] text-white/65">
                      <Check className="w-3.5 h-3.5 flex-shrink-0 mt-0.5" style={{ color: "#e8402b" }} />
                      <span>{f}</span>
                    </li>
                  ))}
                </ul>
                {tier.cta === "Contact Sales" ? (
                  <a
                    ...
                    className="block text-center rounded-full py-3 text-[13px] font-semibold transition-all border border-white/[0.12] bg-white/[0.03] text-white/80 hover:border-[#e8402b]/35 hover:text-[#e8402b]"
                  >
                    {tier.cta}
                  </a>
                ) : (
                  <Link
                    ...
                    className={`block text-center rounded-full py-3 text-[13px] font-semibold transition-all ${
                      tier.featured ? "" : "border border-white/[0.12] bg-white/[0.03] text-white/80 hover:border-[#e8402b]/35 hover:text-[#e8402b]"
                    }`}
      ...
      <section className="relative py-24 md:py-32 border-t border-white/[0.06] overflow-hidden">
        <div className="pointer-events-none absolute inset-0" aria-hidden>
          <div className="absolute left-1/2 top-1/2 h-[560px] w-[1000px] -translate-x-1/2 -translate-y-1/2 rounded-full blur-[140px]"
            style={{ background: "radial-gradient(closest-side, rgba(232,64,43,0.11), transparent 70%)" }} />
        </div>
        <div className="relative max-w-3xl mx-auto px-4 sm:px-6 text-center">
          ...
          <div className="flex flex-wrap items-center justify-center gap-6 mt-8 text-[12px] text-white/55">
            <span className="flex items-center gap-1.5"><Check className="w-3.5 h-3.5" style={{ color: "#e8402b" }} /> No credit card</span>
            <span className="flex items-center gap-1.5"><Check className="w-3.5 h-3.5" style={{ color: "#e8402b" }} /> 14-day free trial</span>
            <span className="flex items-center gap-1.5"><Check className="w-3.5 h-3.5" style={{ color: "#e8402b" }} /> Cancel anytime</span>
          </div>
        </div>
      </section>
    </div>
