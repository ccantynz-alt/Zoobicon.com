        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 text-center">
          ...
          <div className="max-w-xl mx-auto relative mb-8">
            ...
            <input
              ...
              className="w-full rounded-full border border-white/[0.12] bg-white/[0.03] pl-12 pr-5 py-3.5 text-[14px] text-white placeholder:text-white/40 backdrop-blur transition-all focus:outline-none focus:border-[#e8402b]/40 focus:bg-white/[0.05]"
            />
          </div>
          ...
          <div className="flex flex-wrap justify-center gap-2 mb-10">
            <button
              ...
              className={`rounded-full px-4 py-1.5 text-[12px] font-medium transition-all duration-500 ${
                !isFiltering
                  ? "border border-[#e8402b]/35 bg-[#e8402b]/[0.08] text-[#e8402b]"
                  : "border border-white/[0.10] bg-white/[0.03] text-white/60 hover:border-[#e8402b]/25 hover:text-[#e8402b]"
              }`}
            >
              All ({totalGenerators})
            </button>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {[
              ...
              <div key={stat.label} className="text-center">
                <div className="text-4xl md:text-5xl font-semibold tracking-[-0.02em] mb-2" style={{ color: "#e8402b" }}>
                  {stat.value}
                </div>
            ...
            {PIPELINE_TIERS.map((tier) => (
              <div
                ...
                className={`relative overflow-hidden rounded-[24px] p-7 transition-all duration-500 hover:-translate-y-1 ${
                  tier.tag ? "border-2 border-[#e8402b]/35" : "border border-white/[0.08] hover:border-[#e8402b]/25"
                }`}
                style={{
                  background: tier.tag
                    ? "var(--paper-elevated)"
              ...
              >
                ...
                <div className="flex items-center gap-2 text-[12px]" style={{ color: "#e8402b" }}>
        ...
        <section className="relative py-20 md:py-24 border-t border-white/[0.06]">
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            ...
            {filteredGenerators.length === 0 ? (
              ...
              >
                <Search className="w-8 h-8 mx-auto mb-4 text-[#e8402b]/60" />
      ...
      <section className="relative py-24 md:py-32 border-t border-white/[0.06] overflow-hidden">
        ...
        <div className="relative max-w-3xl mx-auto px-4 sm:px-6 text-center">
          ...
          <div className="flex flex-wrap items-center justify-center gap-3">
            ...
            <Link
              href="/builder"
              className="inline-flex items-center gap-2 rounded-full border border-white/[0.12] bg-white/[0.03] px-8 py-4 text-[15px] font-medium text-white/80 backdrop-blur transition-all duration-500 hover:-translate-y-0.5 hover:border-[#e8402b]/35 hover:text-[#e8402b]"
            >
              <Code2 className="w-4 h-4" />
              API docs
            </Link>
...
function GeneratorCard({ gen }: { gen: GeneratorItem }) {
  ...
  return (
    ...
    >
      ...
      {gen.tag && (
        <span
          className="absolute top-5 right-5 rounded-full border border-[#e8402b]/25 bg-[#e8402b]/[0.06] px-2.5 py-0.5 text-[10px] font-semibold uppercase tracking-wide"
          style={{ color: "#e8402b" }}
        >
          {gen.tag}
        </span>
      ...
      <div className="relative">
        <div className="mb-5 inline-flex h-11 w-11 items-center justify-center rounded-xl border border-[#e8402b]/20 bg-[#e8402b]/[0.05]">
          <Icon className="h-5 w-5 text-[#e8402b]" />
        </div>
        ...
        <div className="flex items-center gap-1.5 text-[12px] font-semibold transition-all" style={{ color: "#e8402b" }}>
          <span>Generate</span>
