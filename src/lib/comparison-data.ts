...
const ZOOBICON_TIERS: PricingTier[] = [
  {
    name: "Starter",
    price: "$49 / mo",
    highlights: ["AI builder", "1 domain", "12 free tools"],
  },
  {
    name: "Pro",
    price: "$129 / mo",
    highlights: ["Everything in Starter", "Unlimited AI builds", "Priority models", "5 sites"],
  },
  {
    name: "Agency",
    price: "$299 / mo",
...
export const COMPARISONS: Record<string, CompetitorComparison> = {
  lovable: {
    ...
    metaDescription:
      "Honest 2026 comparison of Zoobicon and Lovable. Lovable hit $400M ARR by polishing one product. Zoobicon pairs the AI Builder with real Domain Search and free tools at a fraction of the cost. See feature-by-feature analysis.",
    stats: {
    ...
    ourPitch:
      "Same builder quality, plus real domain registration and an agency white-label tier — at $49/mo instead of buying each separately.",
    whatTheyDo:
    ...
    ourStrengths: [
      "AI Builder + real Domain Search + agency white-label vs Lovable's single-product focus",
      "Real domain search + registration via OpenSRS — Lovable has no domain layer at all",
      "Builder + Domain Search bundled at $49/mo vs $200+/mo buying each",
    ...
    verdict:
      "Lovable is the right call if all you need is the best-in-class single-product experience and you're happy paying separately for the domain layer. Zoobicon is the right call if you want one login covering the builder and real domain registration in one bill.",
    ...
    whenToPickUs: "You want a single platform that handles the AI Builder, real Domain Search, with an agency white-label tier on top.",
  },
  ...
  bolt: {
    ...
    metaDescription:
      "Honest 2026 comparison of Zoobicon and Bolt.new. Bolt has the fastest in-browser preview thanks to WebContainers. Zoobicon pairs the AI Builder with real domain registration at a single bundled price.",
    stats: {
    ...
    ourPitch:
      "Match Bolt's preview quality, then add what they don't have — real domain search and a white-label agency tier, bundled at $49/mo.",
    whatTheyDo:
    ...
    ourStrengths: [
      "AI Builder + real Domain Search + agency white-label vs Bolt's single-product focus",
      "Real domain search + registration via OpenSRS — Bolt has no domain layer",
            "Builder + Domain Search bundled at /mo",
    ...
    verdict:
      "Bolt is the right call if you only need the fastest in-browser preview for a single React app, and you're comfortable paying separately for the domain layer. Zoobicon matches Bolt's preview quality and adds real Domain Search + agency white-label at one bundled price.",
    whenToPickThem: "You're a solo developer who wants the fastest possible iteration on one app and you don't care about domains or email.",
    whenToPickUs: "You want one platform covering the AI Builder and real Domain Search at a single subscription price.",
  },
  ...
  v0: {
    ...
    metaDescription:
      "Honest 2026 comparison of Zoobicon and v0.app. v0 is the polished UI generator backed by Vercel and locked into their stack. Zoobicon adds real Domain Search on top of the builder, with no Vercel lock-in.",
    stats: {
      users: "6M+ developers",
    ...
    ourPitch:
      "Same React/shadcn quality with no Vercel lock-in, plus real domain registration, white-label agency, and a focused builder-first stack.",
    whatTheyDo:
    ...
    ourStrengths: [
      ...
      "AI Builder + real Domain Search + agency white-label vs v0's single-product focus",
      ...
      "AI Builder + Domain Search bundled at $49/mo",
    ...
    verdict:
      "v0 is the right call if you're already on Vercel, want the cleanest shadcn/ui output, and don't need anything outside the React layer. Zoobicon delivers the same UI quality plus everything around it — the AI Builder + Domain Search combo that closes the gap between a generated UI and a live, brand-owned site.",
    whenToPickThem: "You're a Vercel-stack engineer building a React app inside their ecosystem and you don't need domains or email.",
    whenToPickUs: "You want UI generation AND real Domain Search and agency white-label tooling at one price.",
  },
};
