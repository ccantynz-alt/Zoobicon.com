...
const ZOOBICON_TIERS: PricingTier[] = [
  {
    name: "Starter",
    price: "$49 / mo",
    highlights: ["AI builder", "1 domain", "AI video credits", "12 free tools"],
  },
  {
    name: "Pro",
    price: "$129 / mo",
    highlights: ["Everything in Starter", "Unlimited AI builds", "Full AI Video Creator", "Priority models", "5 sites"],
  },
  {
    name: "Agency",
    price: "$299 / mo",
...
export const COMPARISONS: Record<string, CompetitorComparison> = {
  lovable: {
    ...
    metaDescription:
      "Honest 2026 comparison of Zoobicon and Lovable. Lovable hit $400M ARR by polishing one product. Zoobicon pairs the AI Builder with AI Video, Domain Search, and free tools at a fraction of the cost. See feature-by-feature analysis.",
    stats: {
    ...
    ourPitch:
      "Same builder quality, plus real domain registration, an own-stack AI video creator, and an agency white-label tier — at $49/mo instead of buying each separately.",
    whatTheyDo:
    ...
    ourStrengths: [
      "AI Builder + AI Video + real Domain Search vs Lovable's single-product focus",
      ...
      "Builder + AI Video + Domain Search bundled at $49/mo vs $200+/mo buying each",
    ...
    features: [
      ...
      { feature: "AI video creator (own pipeline)", us: "us", them: "neither" },
    ...
    verdict:
      "Lovable is the right call if all you need is the best-in-class single-product experience and you're happy paying separately for the domain layer and video. Zoobicon is the right call if you want one login covering the builder, the video creator, and real domain registration in one bill.",
    whenToPickThem: "You only need a website builder, you're already paying separately for the domain layer, and you want the absolute best Supabase auto-provisioning available.",
    whenToPickUs: "You want a single platform that handles the AI Builder, AI Video Creator, and real Domain Search, with an agency white-label tier on top.",
  },
  ...
  bolt: {
    ...
    metaDescription:
      "Honest 2026 comparison of Zoobicon and Bolt.new. Bolt has the fastest in-browser preview thanks to WebContainers. Zoobicon pairs the AI Builder with AI Video and real domain registration at a single bundled price.",
    stats: {
    ...
    ourPitch:
      "Match Bolt's preview quality, then add what they don't have — real domain search, an own AI video pipeline, and a white-label agency tier, bundled at $49/mo.",
    whatTheyDo:
    ...
    ourStrengths: [
      "AI Builder + AI Video + real Domain Search vs Bolt's single-product focus",
      ...
      "Builder + AI Video + Domain Search bundled at $49/mo",
    ...
    verdict:
      "Bolt is the right call if you only need the fastest in-browser preview for a single React app, and you're comfortable paying separately for the domain layer. Zoobicon matches Bolt's preview quality and adds real Domain Search + own AI Video at one bundled price.",
    ...
    whenToPickUs: "You want one platform covering the AI Builder, AI Video Creator, and real Domain Search at a single subscription price.",
  },
  ...
  v0: {
    ...
    metaDescription:
      "Honest 2026 comparison of Zoobicon and v0.app. v0 is the polished UI generator backed by Vercel and locked into their stack. Zoobicon adds real Domain Search and an own AI video pipeline on top of the builder, with no Vercel lock-in.",
    stats: {
      users: "6M+ developers",
    ...
    ourPitch:
      "Same React/shadcn quality with no Vercel lock-in, plus real domain registration, AI video, white-label agency, and a focused builder-first stack.",
    whatTheyDo:
    ...
    ourStrengths: [
      "No Vercel lock-in — deploy through our partner cloud or your own host",
      "AI Builder + AI Video + real Domain Search vs v0's single-product focus",
      ...
      "AI Builder + AI Video + Domain Search at $49/mo all-in",
    ...
    verdict:
      "v0 is the right call if you're already on Vercel, want the cleanest shadcn/ui output, and don't need anything outside the React layer. Zoobicon delivers the same UI quality plus everything around it — the AI Builder + AI Video + Domain Search combo that closes the gap between a generated UI and a live, brand-owned site.",
    ...
    whenToPickUs: "You want UI generation AND real Domain Search, AI Video, and agency white-label tooling at one price.",
  },
  ...
  heygen: {
    ...
    metaDescription:
      "Honest 2026 comparison of Zoobicon and HeyGen. HeyGen leads avatar quality and language coverage. Zoobicon's pipeline is 10–20× cheaper and pairs the video creator with the AI Builder and real Domain Search.",
    stats: {
      arr: "$100M+ ARR",
      valuation: "$500M+",
      users: "Millions",
    ...
    ourPitch:
      "Match HeyGen's quality at 10–20× lower per-video cost via Hedra Character-3 + Fish Audio S1 — and pair the video creator with the AI Builder + Domain Search at $49/mo.",
    whatTheyDo:
    ...
    ourStrengths: [
      ...
      "Pair AI Video with the AI Builder + Domain Search at $49/mo",
      "AI Video + AI Builder + Domain Search vs HeyGen's single-product focus",
    ...
    features: [
      ...
      { feature: "Paired with AI Builder + Domain Search", us: "us", them: "neither" },
    ...
    verdict:
      "HeyGen is the right call if you're a large enterprise that needs the absolute peak of avatar fidelity and you have the budget to match. Zoobicon delivers ~90% of HeyGen's output quality at a fraction of the cost — and pairs the video pipeline with the AI Builder and Domain Search.",
