...
export interface Country {
  ...
  /** Payment methods that work locally (via Stripe through Crontech) */
  paymentMethods: string[];
  /** Niches especially popular in this market (slug refs into niches.ts) */
  popularNiches: string[];
  /** Crontech-suggested hosting region for low latency */
...
const countries: Country[] = [
  {
    ...
    metaPitch: "AI website builder for the US market. Stripe USD checkout, .com domain registration via Crontech, hosting in iad1. Restaurants, SaaS, real-estate, agencies.",
    marketContext: [
      "Stripe USD billing — the default for any US business",
      "Vercel iad1 hosting region via Crontech — sub-50ms latency from the East Coast",
    ...
    faqs: [
      {
        ...
        a: "Yes — Zoobicon is built on Stripe USD by default, hosts customer sites through Crontech's iad1 region for sub-50ms East Coast latency, and ships .com domain registration through the same checkout. Most niche templates (restaurants, SaaS, real estate, law firms) target the US market by default.",
      },
      {
      ...
      },
      {
        ...
        a: "The generated site emits standard data-driven checkout CTAs. While Stripe through Crontech is the default, the React codebase is yours — wire up Square, Authorize.Net, or PayPal if your business already runs on one of them.",
      },
    ],
  },
  {
    ...
    metaPitch: "AI website builder for UK businesses. Stripe GBP, .co.uk and .uk domains via Crontech, hosting in lhr1. Tailored for restaurants, SaaS, agencies, professional services.",
    marketContext: [
      "Stripe GBP billing with VAT-compliant receipts",
      "Vercel lhr1 (London) hosting region via Crontech",
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "Yes — .co.uk and .uk are registered via Crontech's API at deploy time. Standard registration fees apply (typically £7-15/yr depending on TLD).",
      },
      {
        q: "Where will my customer site be hosted?",
        a: "By default, Crontech hosts UK customer sites in their London (lhr1) region for sub-30ms latency across the UK.",
      },
    ],
  },
  {
    ...
    metaPitch: "AI website builder for Canada. Stripe CAD, .ca domains via Crontech, hosting in Toronto. Tailored for restaurants, SaaS, real-estate, professional services.",
    marketContext: [
      "Stripe CAD billing with GST/HST/QST tax handling",
      "Vercel yyz1 (Toronto) hosting region via Crontech for low cross-Canada latency",
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "Yes — .ca registration via Crontech goes through CIRA's accredited registrar partners. Note that .ca requires Canadian presence (citizen, resident, or registered Canadian business) per CIRA rules.",
      },
    ],
  },
  {
    ...
    metaPitch: "AI website builder for Australia. Stripe AUD, .com.au domains via Crontech, hosting in syd1. Tailored for restaurants, agencies, trades, professional services.",
    marketContext: [
      "Stripe AUD billing with GST-compliant receipts",
      "Vercel syd1 (Sydney) hosting region via Crontech for sub-30ms across AU",
    ...
    faqs: [
      {
        ...
        a: "Yes — .com.au registration through Crontech requires a valid ABN, ACN, or registered business name per auDA rules. The deploy flow checks this before completing registration.",
      },
      {
        q: "Will Australian customers see Afterpay and Zip on my site?",
        a: "Yes — when you wire Stripe through Crontech's billing layer, Stripe's Afterpay/Zip surfaces appear automatically for Australian shoppers at checkout.",
      },
    ],
  },
  {
    ...
    metaPitch: "AI website builder for New Zealand. Stripe NZD, .co.nz and .nz domains via Crontech, hosting in syd1. Built by a Kiwi team for Kiwi businesses.",
    marketContext: [
      "Built in New Zealand — Zoobicon's HQ is in Aotearoa",
      "Stripe NZD billing with GST-compliant receipts",
      "Vercel syd1 (Sydney) hosting via Crontech — sub-50ms across NZ",
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "Yes — .co.nz, .nz, and .kiwi registrations are handled through Crontech's API at deploy time. Standard NZ registry fees apply.",
      },
    ],
  },
  {
    ...
    metaPitch: "AI website builder for Ireland. Stripe EUR, .ie domains via Crontech, hosting in dub1. EU-compliant, GDPR-ready out of the box.",
    marketContext: [
      "Stripe EUR billing with VAT-compliant Irish receipts",
      "Vercel dub1 (Dublin) hosting region via Crontech",
    ...
    faqs: [
      {
        ...
        a: "Yes — .ie registration through Crontech requires proof of Irish connection (resident, business, organization) per IEDR rules. The deploy flow checks before completing.",
      },
      {
  ...
  },
  {
    ...
    metaPitch: "AI website builder for Germany. Stripe EUR, .de domains via Crontech, hosting in fra1. GDPR-strict mode + Impressum copy by default.",
    marketContext: [
      "Stripe EUR billing with VAT receipts that meet German Finanzamt requirements",
      "Vercel fra1 (Frankfurt) hosting region via Crontech",
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "Über Stripe (via Crontech) unterstützen wir Sofort, Giropay, SEPA-Lastschrift, Kreditkarten, Apple Pay und Google Pay. Klarna und PayPal über separate Integrationen.",
      },
    ],
  },
  {
    ...
    metaPitch: "Constructeur de sites web IA pour la France. Stripe EUR, domaines .fr via Crontech, hébergement à Paris (cdg1). Mentions légales + RGPD prêtes.",
    marketContext: [
      "Stripe EUR billing with TVA receipts",
      "Vercel cdg1 (Paris) hosting region via Crontech",
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "Oui — l'enregistrement .fr passe par les registrars accrédités AFNIC via Crontech. Tarifs standards (typiquement 8-15€/an).",
      },
    ],
  },
  {
    ...
    metaPitch: "Creador de sitios web con IA para España. Stripe EUR, dominios .es vía Crontech, hosting en mad1. Aviso legal + RGPD por defecto.",
    marketContext: [
      "Stripe EUR billing with IVA receipts",
      "Vercel mad1 (Madrid) hosting region via Crontech",
  ...
  },
  {
    ...
    metaPitch: "Creatore di siti web con IA per l'Italia. Stripe EUR, domini .it via Crontech, hosting a Milano (mxp1). GDPR-conforme dal primo deploy.",
    marketContext: [
      "Stripe EUR billing with IVA-compliant receipts (richiesta fattura elettronica)",
      "Vercel mxp1 (Milan) hosting region via Crontech",
  ...
  },
  {
    ...
    metaPitch: "AI website builder voor Nederland. Stripe EUR met iDEAL, .nl domeinen via Crontech, hosting in Amsterdam (ams1). AVG-compliant standaard.",
    marketContext: [
      "Stripe EUR billing with BTW-compliant receipts",
      "Vercel ams1 (Amsterdam) hosting via Crontech",
    ...
    faqs: [
      {
        ...
        a: "Ja — Stripe via Crontech ondersteunt iDEAL standaard voor Nederlandse klanten. iDEAL verschijnt automatisch in de checkout voor Nederlandse shoppers.",
      },
    ],
  },
  {
    ...
    metaPitch: "AI website builder for Sweden. Stripe SEK with Swish, .se domains via Crontech, hosting in arn1. GDPR + Swedish consumer law compliant.",
    marketContext: [
      "Stripe SEK billing with moms-compliant receipts",
      "Vercel arn1 (Stockholm) hosting via Crontech",
    ...
    faqs: [
      {
        ...
        a: "Ja — Stripe via Crontech stödjer Swish som standard för svenska kunder. Swish visas automatiskt i checkouten.",
      },
    ],
  },
  {
    ...
    metaPitch: "Construtor de sites com IA para o Brasil. Stripe BRL com PIX, domínios .com.br via Crontech, hospedagem em São Paulo (gru1). LGPD-conforme.",
    marketContext: [
      "Stripe BRL billing with NF-e–compatible receipts",
      "Vercel gru1 (São Paulo) hosting via Crontech",
    ...
    faqs: [
      {
        ...
        a: "Sim — Stripe via Crontech suporta PIX como método de pagamento padrão para clientes brasileiros. PIX aparece automaticamente no checkout.",
      },
      {
        q: "Posso registrar um domínio .com.br?",
        a: "Sim — registro .com.br via Crontech passa pelo Registro.br. Requer CPF ou CNPJ brasileiro conforme as regras do registro.",
      },
    ],
  },
  {
    ...
    metaPitch: "Creador de sitios web con IA para México. Stripe MXN con OXXO, dominios .com.mx vía Crontech, hosting en Querétaro (qro1). LFPDPPP-conforme.",
    marketContext: [
      "Stripe MXN billing with CFDI-compatible receipts (factura)",
      "Vercel qro1 (Querétaro) hosting region via Crontech",
    ...
    faqs: [
      {
        q: "¿Funciona con OXXO?",
        a: "Sí — Stripe vía Crontech soporta pagos OXXO por defecto para clientes mexicanos. OXXO aparece automáticamente en el checkout para compradores en México.",
      },
    ],
  },
  {
    ...
    metaPitch: "AI website builder for India. Stripe INR with UPI, .in domains via Crontech, hosting in bom1. Built for India's mobile-first commerce.",
    marketContext: [
      "Stripe INR billing with GST-compliant receipts",
      "Vercel bom1 (Mumbai) hosting region via Crontech",
    ...
    faqs: [
      {
        ...
        a: "Yes — Stripe via Crontech supports UPI as a default payment method for Indian customers. UPI appears automatically in checkout for Indian shoppers.",
      },
      {
        q: "Can I register a .in domain?",
        a: "Yes — .in and .co.in registration through Crontech goes via NIXI's accredited registrar partners. Standard NIXI fees apply.",
      },
    ],
  },
  {
    ...
    metaPitch: "AI website builder for Singapore. Stripe SGD with PayNow, .sg domains via Crontech, hosting in sin1. Built for Singapore's enterprise + SME market.",
    marketContext: [
      "Stripe SGD billing with GST-inclusive receipts",
      "Vercel sin1 (Singapore) hosting region via Crontech",
    ...
    faqs: [
      {
        ...
        a: "Yes — Stripe via Crontech supports PayNow as a default payment method for Singaporean customers. PayNow appears automatically in checkout for SG shoppers.",
      },
    ],
  },
  {
    ...
    metaPitch: "AI website builder for the UAE. Stripe AED with cards, .ae domains via Crontech, hosting in fra1 (low-latency to MENA). Built for Dubai's startup market.",
    marketContext: [
      "Stripe AED billing with VAT-compliant receipts",
      "Vercel fra1 (Frankfurt) hosting via Crontech — sub-100ms to UAE",
  ...
  },
  {
    ...
    metaPitch: "AI website builder for South Africa. Stripe ZAR, .co.za domains via Crontech, hosting in cpt1. POPIA-aligned cookie banner by default.",
    marketContext: [
      "Stripe ZAR billing with VAT-compliant receipts",
      "Vercel cpt1 (Cape Town) hosting region via Crontech",
      ".co.za through ZACR",
  ...
  },
  {
    ...
    metaPitch: "AI website builder for Japan. Stripe JPY with Konbini + Pay-easy, .jp domains via Crontech, hosting in hnd1. Built for Japan's mobile-first commerce.",
    marketContext: [
      "Stripe JPY billing with Japanese consumption-tax-compliant receipts",
      "Vercel hnd1 (Tokyo) hosting region via Crontech",
    ...
    faqs: [
      {
        ...
        a: "はい、CrontechのStripe統合により、日本のお客様にはKonbini（コンビニ）決済とPay-easyがデフォルトで利用可能です。チェックアウト時に自動的に表示されます。",
      },
    ],
  },
  {
    ...
    metaPitch: "AI website builder for South Korea. Stripe KRW, .kr domains via Crontech, hosting in icn1. Built for Korea's mobile-commerce + KakaoTalk culture.",
    marketContext: [
      "Stripe KRW billing with VAT-compliant receipts",
      "Vercel icn1 (Seoul) hosting region via Crontech",
    ...
    faqs: [
      {
        ...
        a: "Stripe via Crontech의 직접 카카오페이 통합은 로드맵에 있습니다. 현재로서는 별도의 카카오페이 가맹점 계정을 통해 통합할 수 있으며, 생성된 React 코드베이스에 직접 배선됩니다.",
      },
    ],
  },
];
