        ...
        <div className="space-y-2">
          ...
          {history.map((run, idx) => (
            ...
            >
              ...
              {idx === 0 && (
                <span className="text-[10px] text-white/50 px-1.5 py-0.5 rounded bg-white/5">
                  Latest
                </span>
              )}
            </button>
                    ...
                    <div className="px-3 pb-3 pt-1 space-y-2">
                      ...
                      {check.suggestions.length > 0 && (
                        <div className="mt-2 pt-2 border-t border-white/5">
                          <div className="text-[10px] text-white/50 mb-1 uppercase tracking-wider">
                            Suggestions
                          </div>
                          {check.suggestions.map((s, idx) => (
                            <div
                              key={idx}
                              className="text-[11px] text-white/50 py-0.5 flex items-start gap-1.5"
                            >
                              <Sparkles
                                size={10}
