...
export default function BusinessChat() {
  ...
  return (
    <div
      className={`fixed bottom-6 right-6 z-50 bg-[var(--paper-elevated)] border border-white/10 rounded-2xl shadow-2xl shadow-black/50 flex flex-col transition-all duration-300 ${
