    ...
    <div className="flex flex-col gap-3 p-3 rounded-xl bg-white/[0.02] border border-white/[0.06]">
      ...
      <div>
        <div className="flex items-center gap-1.5 mb-2">
          ...
          <span className="text-[10px] uppercase tracking-[1.5px] text-white/40">Color Palette</span>
        </div>
      ...
      <div>
        <div className="flex items-center gap-1.5 mb-2">
          ...
          <span className="text-[10px] uppercase tracking-[1.5px] text-white/40">Typography</span>
        </div>
        <div className="grid grid-cols-2 gap-1.5">
          {TYPOGRAPHY_OPTIONS.map((t) => (
            ...
            >
              ...
              <span className={`text-[9px] ${options.typography === t.id ? "text-brand-300/50" : "text-white/25"}`}>
                {t.desc}
              </span>
            </button>
          ))}
      ...
      <div>
        <div className="flex items-center gap-1.5 mb-2">
          ...
          <span className="text-[10px] uppercase tracking-[1.5px] text-white/40">Layout Style</span>
        </div>
        <div className="grid grid-cols-2 gap-1.5">
          {LAYOUT_OPTIONS.map((l) => (
            ...
            >
              ...
              <span className={`text-[9px] ${options.layout === l.id ? "text-brand-300/50" : "text-white/25"}`}>
                {l.desc}
              </span>
            </button>
          ))}
      ...
      <div>
        <div className="flex items-center gap-1.5 mb-2">
          ...
          <span className="text-[10px] uppercase tracking-[1.5px] text-white/40">Sections</span>
        </div>
        <div className="flex flex-wrap gap-1.5">
            ...
            return (
              <button
                ...
                className={`px-2.5 py-1 rounded-lg text-[11px] transition-all ${
                  active
                    ? "bg-brand-500/15 border border-brand-500/30 text-brand-300"
                    : "bg-white/[0.03] border border-white/[0.06] text-white/30 hover:border-white/10 hover:text-white/50"
                }`}
              >
                {section}
              </button>
