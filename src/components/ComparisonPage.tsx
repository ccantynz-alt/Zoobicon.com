    ...
    <div className="relative z-10 min-h-screen bg-[var(--paper)] text-[var(--ink)] pt-[72px]">
      ...
      <section className="relative pt-20 md:pt-28 pb-16 px-4 overflow-hidden">
        <div className="pointer-events-none absolute inset-0" aria-hidden>
          <div
            ...
            style={{ background: "radial-gradient(closest-side, rgba(232,64,43,0.10), transparent 70%)" }}
          />
        </div>

        <div className="relative max-w-5xl mx-auto text-center">
          <div className="inline-flex items-center gap-2 rounded-full border border-[#e8402b]/25 bg-[#e8402b]/[0.06] px-3.5 py-1.5 text-[11px] font-semibold tracking-[0.2em] uppercase text-[#e8402b] mb-6">
          ...
          <div className="mt-10 flex flex-wrap items-center justify-center gap-3">
            <Link
              ...
              style={{
                ...
                boxShadow: "0 8px 24px -8px rgba(232,64,43,0.4)",
              }}
            >
      ...
      <section className="max-w-3xl mx-auto px-4 py-10">
        <div className="rounded-3xl border border-white/[0.07] bg-white/[0.02] p-7 md:p-9">
          <h2 className="text-[11px] uppercase tracking-[0.2em] font-semibold text-[#e8402b]/85 mb-3">
      ...
      <section className="max-w-3xl mx-auto px-4 py-6">
        <div
          ...
          style={{
            background:
              "linear-gradient(135deg, rgba(232,64,43,0.06) 0%, rgba(99,102,241,0.06) 50%, rgba(16,24,40,0.7) 100%)",
            borderColor: "rgba(232,64,43,0.20)",
          }}
        >
          <h2 className="text-[11px] uppercase tracking-[0.2em] font-semibold text-[#e8402b] mb-3">
            Where Zoobicon wins
          </h2>
          ...
          <ul className="space-y-2.5">
            {data.ourStrengths.map((s, i) => (
              <li key={i} className="flex items-start gap-3 text-[14px] text-white/85">
                <Trophy className="w-4 h-4 text-[#e8402b] mt-0.5 flex-shrink-0" />
                {s}
              </li>
            ))}
          </ul>
      ...
      <section className="max-w-4xl mx-auto px-4 py-14">
        ...
        <div className="rounded-3xl border border-white/[0.07] bg-white/[0.015] backdrop-blur-sm overflow-hidden">
          <div className="grid grid-cols-[1fr_120px_120px] md:grid-cols-[1fr_180px_180px]">
            ...
            <div className="px-5 py-4 text-[11px] uppercase tracking-widest font-semibold text-center bg-[#e8402b]/[0.05] text-[#e8402b]">
              Zoobicon
            </div>
            ...
            {data.features.map((row, i) => (
              <div key={i} className="contents">
                ...
                <div className="px-5 py-3.5 text-center border-t border-white/[0.05] bg-[#e8402b]/[0.02]">
      ...
      <section className="max-w-5xl mx-auto px-4 py-14">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div
            ...
            style={{
              background:
                "linear-gradient(135deg, rgba(232,64,43,0.06) 0%, rgba(16,24,40,0.7) 100%)",
              borderColor: "rgba(232,64,43,0.22)",
            }}
          >
            <h3 className="text-[11px] uppercase tracking-[0.2em] font-semibold text-[#e8402b] mb-4">
              Zoobicon
            </h3>
              ...
              {data.ourTiers.map((t) => (
                <div key={t.name} className="border-t border-white/[0.07] pt-3 first:border-t-0 first:pt-0">
                  <div className="flex items-baseline justify-between gap-3 mb-1.5">
                    ...
                    <span className="font-semibold text-[15px] text-[#e8402b]">{t.price}</span>
                  </div>
      ...
      <section className="max-w-4xl mx-auto px-4 py-14">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          >
            <h3 className="text-[11px] uppercase tracking-[0.2em] font-semibold text-[#e8402b] mb-3">
              Pick Zoobicon if
            </h3>
