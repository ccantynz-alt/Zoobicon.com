      ...
      <div
        ...
        style={{
          background: isSpeaking
            ? "radial-gradient(ellipse at 50% 60%, rgba(16,185,129,0.18) 0%, rgba(232,64,43,0.10) 60%, transparent 100%)"
            : "radial-gradient(ellipse at 50% 60%, rgba(232,64,43,0.08) 0%, transparent 70%)",
        }}
      />
