...
export default function GitHubImport({ onImport }: GitHubImportProps) {
  ...
  return (
    <div className="w-full max-w-2xl mx-auto space-y-6">
      {/* Input Section */}
      <div className="rounded-xl border border-white/10 bg-[var(--paper-elevated)] p-6 space-y-4">
      ...
      {/* Progress Steps */}
      {isLoading && (
        <div className="rounded-xl border border-white/10 bg-[var(--paper-elevated)] p-6 space-y-3">
      ...
      {/* Results Panel */}
      {result && (
        <div className="rounded-xl border border-white/10 bg-[var(--paper-elevated)] p-6 space-y-5">
