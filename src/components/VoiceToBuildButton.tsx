  ...
  return (
    <>
      <motion.button
        ...
        style={listening
          ? { background: "linear-gradient(135deg, #ef5440 0%, #9c7a2c 100%)", boxShadow: "0 4px 16px rgba(232,64,43,0.5)" }
          : { background: "linear-gradient(135deg, #ef5440 0%, #e8402b 100%)", boxShadow: "0 2px 8px rgba(232,64,43,0.3)" }}
      >
        {listening && (
          <>
            <motion.span
