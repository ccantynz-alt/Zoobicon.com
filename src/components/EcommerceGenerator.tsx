        ...
        <div className="flex items-center justify-between p-4 border-b border-zinc-800">
          ...
          <div className="flex gap-3">
            ...
            <button
              ...
              className="px-4 py-2 rounded-lg bg-purple-600 hover:bg-purple-500 text-white transition-colors text-sm font-medium"
            >
              Use This Store
              ...
              {i < STEPS.length - 1 && (
                <div
                  className={`w-12 sm:w-20 h-0.5 mx-2 transition-colors ${
                    i < currentStep ? "bg-purple-600" : "bg-zinc-800"
                  }`}
                />
              )}
            </div>
        ...
        <div>
          ...
          {businessType === "Custom" && (
            <input
              ...
              className="mt-4 w-full p-3 rounded-lg bg-zinc-900 border border-zinc-700 text-white placeholder-zinc-500 focus:outline-none focus:border-purple-500"
            />
          )}
        </div>
      )}
          ...
          {showCsvPaste && (
            <div className="mb-6 p-4 rounded-lg bg-zinc-900 border border-zinc-700">
              ...
              <textarea
                ...
                rows={5}
                className="w-full p-3 rounded-lg bg-zinc-800 border border-zinc-600 text-white placeholder-zinc-500 focus:outline-none focus:border-purple-500 text-sm font-mono"
              />
              ...
              >
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  <input
                    ...
                    className="p-2.5 rounded-lg bg-zinc-800 border border-zinc-700 text-white placeholder-zinc-500 focus:outline-none focus:border-purple-500 text-sm"
                  />
                  <input
                    type="number"
                    placeholder="Price"
                ...
                <input
                  ...
                  className="w-full p-2.5 rounded-lg bg-zinc-800 border border-zinc-700 text-white placeholder-zinc-500 focus:outline-none focus:border-purple-500 text-sm"
                />
              </div>
            ))}
          </div>
