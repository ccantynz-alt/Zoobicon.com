...
export default function ProjectTree({
  ...
  return (
    <div className="flex flex-col h-full bg-[var(--paper)] border-r border-white/10 select-none">
      {/* Header */}
      ...
      {contextMenu && (
        <div
          ref={contextMenuRef}
          className="fixed z-50 bg-[var(--paper)] border border-white/10 rounded-md shadow-xl py-1 min-w-[140px]"
      ...
      {renamingPath && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
          <div className="bg-[var(--paper)] border border-white/10 rounded-lg p-4 w-80 shadow-2xl">
