...
export default function VisualEditor({ active, onEdit, files, onToggle }: VisualEditorProps) {
  ...
  return (
    <div className="absolute top-0 left-0 right-0 z-30">
      {/* Toolbar */}
      <div className="flex items-center gap-1 px-3 py-2 bg-[var(--paper)]/95 backdrop-blur-sm border-b border-white/10">
      ...
      {tool === "color" && (
        <div className="mx-3 mt-2 p-3 rounded-xl bg-[var(--paper)]/95 backdrop-blur-sm border border-white/10">
