...
.product-img{height:90px;position:relative;background-size:cover;background-position:center}
...
<div class="products">
<div class="product"><div class="product-img" style="background-image:url('https://images.unsplash.com/photo-1568901346375-23c9450c58cd?w=400&h=200&fit=crop');background-size:cover;background-position:center"><span class="product-badge">BESTSELLER</span></div><div class="product-body"><div class="product-name">Truffle Wagyu Burger</div><div class="product-desc">A5 wagyu patty, truffle aioli, aged gruyere, brioche bun</div><div class="product-row"><span class="product-price">$28</span><button class="product-btn">Add to Cart</button></div></div></div>
<div class="product"><div class="product-img" style="background-image:url('https://images.unsplash.com/photo-1467003909585-2f8a72700288?w=400&h=200&fit=crop');background-size:cover;background-position:center"><span class="product-badge" style="background:#16A34A">NEW</span></div><div class="product-body"><div class="product-name">Miso Glazed Salmon</div><div class="product-desc">Wild-caught salmon, white miso, pickled ginger, jasmine rice</div><div class="product-row"><span class="product-price">$34</span><button class="product-btn">Add to Cart</button></div></div></div>
<div class="product"><div class="product-img" style="background-image:url('https://images.unsplash.com/photo-1488477181946-6428a0291777?w=400&h=200&fit=crop');background-size:cover;background-position:center"></div><div class="product-body"><div class="product-name">Berry Panna Cotta</div><div class="product-desc">Vanilla bean panna cotta, mixed berry compote, mint</div><div class="product-row"><span class="product-price">$16</span><button class="product-btn">Add to Cart</button></div></div></div>
</div>
