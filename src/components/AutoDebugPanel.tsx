...
export default function AutoDebugPanel({ code, onApplyFix }: AutoDebugPanelProps) {
  ...
  return (
    <div className="flex flex-col gap-3">
      ...
      <div className="flex flex-col gap-2 p-3 rounded-lg border border-white/10 bg-[var(--paper-elevated)]">
        {/* Auto-Fix Toggle */}
      ...
      {iterations.length > 0 && (
        <div className="rounded-lg border border-white/10 bg-[var(--paper-elevated)] overflow-hidden">
