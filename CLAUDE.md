...
## Last updated: 2026-06-10 (ZOOBICON BOLD v4: full Klaviyo ARCHITECTURE — photographic hero w/ floating product UI, brand-mark statement + explore cards, dark pipeline band, agents split w/ product frame, red stat ticker. ON BRANCH AWAITING CRAIG'S VISUAL APPROVAL — do NOT merge to main without his explicit yes; he reviews the Vercel preview because hero photography (Unsplash hot-link) cannot render in the sandbox) | Build: GREEN | Scope: AI WEBSITE BUILDER ONLY (Rule 32) | Branch: claude/ai-builder-platform-la5d1g
